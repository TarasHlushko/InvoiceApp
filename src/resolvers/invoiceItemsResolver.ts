...
import { ICreateInvoiceItemInput } from '../util/invoiceItemResolverInterfaces/createInvoiceItemInputInterface';
import { IUpdateInvoiceItemInput } from '../util/invoiceItemResolverInterfaces/updateInvoiceItemInputInterface';
import { IInvoiceItem } from '../util/invoiceItemResolverInterfaces/invoiceItemInterface';
...
export const invoiceItemsResolver = {
  Mutation: {
    ...
    async softDeleteInvoiceItem(_, args: IInvoiceItem, context: IContext) {
      const invoiceItem = await InvoiceItemsDb.findByPk(args.id);
