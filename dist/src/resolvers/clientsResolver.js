import { Client as ClientDb, Company as CompanyDb, CompanyMember as CompanyMemberDb, } from '../config/dbConfig.js';
import throwCustomError, { ErrorType } from '../util/error-handler.js';
import { ValidationError } from 'sequelize';
export const clientResolver = {
    Query: {
        async listClientByCompany(_, args, context) {
    ...
    Mutation: {
        ...
        async softDeleteClient(_, args, context) {
